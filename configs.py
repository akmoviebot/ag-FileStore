...
class Config(object):
	API_ID = int(os.environ.get("API_ID", "27084955"))
	API_HASH = os.environ.get("API_HASH","91c88b554ab2a34f8b0c72228f06fc0b")
	BOT_TOKEN = os.environ.get("BOT_TOKEN")
	BOT_USERNAME = os.environ.get("BOT_USERNAME","Filetostorebot")
	...
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002249219491")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", None)
	BANNED_USERS = set(int(x) for x in os.environ.get("BANNED_USERS", "None").split())
	FORWARD_AS_COPY = bool(os.environ.get("FORWARD_AS_COPY", True))
	BROADCAST_AS_COPY = bool(os.environ.get("BROADCAST_AS_COPY", False))
	BANNED_CHAT_IDS = list(set(int(x) for x in os.environ.get("BANNED_CHAT_IDS", "123456789").split()))
